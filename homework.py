...
class Training:
    ...
    M_IN_KM: int = 1000 #meters in 1 km
...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coef_cal_1: int = 18
        coef_cal_2: int = 20
        spent_calories = (coef_cal_1 * self.get_mean_speed() - coef_cal_2) * self.weight / self.M_IN_KM * (self.duration * 60)
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coef_weight_1: float = coef_cal_1 * self.weight
        coef_weight_2: float = coef_cal_2 * self.weight
        spent_calories = (coef_weight_1 + (self.get_mean_speed()**2 // self.height) * coef_weight_2) * (self.duration * 60)
        return spent_calories
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coef_cal_2: float = 2
        spent_calories = (self.get_mean_speed() + coef_cal_1) * coef_cal_2 * self.weight
        return spent_calories
